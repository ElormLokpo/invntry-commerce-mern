...
export const Input = ({ label, type, style_type, placeholder, name, onChangeHandler, isError }: IProps) => {
    ...
    let error_style_auth = "border border-red-400 bg-gray-50 w-full rounded text-sm py-1.5 px-1"
    let error_style_def = "border border-red-400 w-full rounded text-sm py-1 px-1"
